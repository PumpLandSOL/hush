...
const B = 'http://localhost:8212'; const A = '0x00000000000000000000000000000000000000c3', C = '0x00000000000000000000000000000000000000d4';
...
(async () => {
  ...
  const page = await (await fetch(B + '/view')).text(); ok('/view page served', /Carbon Copy/.test(page));
