...
const B = 'http://localhost:8212'; const W = '0x00000000000000000000000000000000000000a1';
...
(async () => {
  ...
  ok('fresh wallet has ZERO seeded USDG', acc.usdg === 0 && acc.hush === 0, JSON.stringify({ usdg: acc.usdg, hush: acc.hush }));
  ...
  ok('stake refused (no hUSD or happy closed)', !!st.error, st.error);
