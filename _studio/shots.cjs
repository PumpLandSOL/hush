...
const B = 'http://localhost:8214', Wt = '0x00000000000000000000000000000000000000d1';
...
(async () => {
  ...
  await js(`tab('shield');set(2000);`); await S('04-cloak-typed');
  await js(`$('act').click();`); await sleep(600); await js(`$('toast').className='toast';`); await S('05-cloaked');
